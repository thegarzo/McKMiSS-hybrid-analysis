...
def main():
    ...
    sanity_dir= output_dir+"/SanityPlots_finest"
    ...
    bin_edges=[0,2.5, 5, 7.5, 10,15, 20,25,  30,35, 40,45, 50,55, 60,65, 70,75, 80, 100]
    # let's make spectra normal
    ...
    ####  SAVE DICTIONARY  ####
    with open(data_dir+'/spectra_finest.pkl', 'wb') as f:
    ...
    ####  SAVE DICTIONARY  ####
    with open(data_dir+'/flow_finest.pkl', 'wb') as f:
        pickle.dump(flow, f)
    ####  PLOT PLOT PLOT PLOT  ####
